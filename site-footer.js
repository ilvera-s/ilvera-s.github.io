...
(function () {
    ...
    const SIGNATURE = 'Ильвера Ситдикова. Духовный наставник.';
    ...
    function linkMarkup(contact) {
        const attrs = contact.sameTab ? '' : ' target="_blank" rel="noopener noreferrer"';
        const inner = contact.icon ? iconMarkup(contact.icon) : '<span class="site-footer__max" aria-hidden="true">' + contact.text + '</span>';
